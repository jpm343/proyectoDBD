...
class Vuelo extends Model
{
    ...
    protected $fillable = ['id_vuelo', 'fecha_salida', 'fecha_llegada', 'equipaje', 'ciudad_origen', 'ciudad_destino', 'aeropuerto_origen', 'aeropuerto_destino', 'pais_origen', 'pais_destino',  'nombre_aerolinea',];
