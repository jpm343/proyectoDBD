			...
			<div class="col-md-6" align="right">
				...
				<form action="{{route('Traslado_opciones')}}" method="GET">
					<div class="form-group" align="left" > 
						...
						<input type="date" class="form-control" name="fecha_traslado"/>
					</div>
					<div class="form-group" align="left" > 
					...
					<div class="form-group" align="left" >
						...
						<input type="text" class="form-control" name="origen_traslado">
					</div>
					<div class="form-group" align="left" >
					...
					<div class="form-group" align="left" >
						...
						<input type="text" class="form-control" name="destino_traslado">
					</div>
					<div class="form-group" align="left" >
						<label >Cantidad de pasajeros</label>
						<input class="form-control" type="number" min="1" step="1" value="1" name="cantidad_pasajeros">
					</div>
					<div class="form-group" align="left" >
						<label >Precio traslado máximo</label>
						<input class="form-control" type="number" min="0" step="1" value="0" name="precio_traslado">
					</div>
					<div class="form-group">
						<button class="btn btn-link-primary" herf="{{route('Traslado.index', 'TrasladoController')}}" align="right"> Buscar traslados</button>
					</div>
				</form>
			</div> 
		</div>
